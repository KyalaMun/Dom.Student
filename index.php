        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarContent">
                    ...
                    <li class="nav-item">
                        <a href="" class="nav-link">Сотрудники</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-items dropdown">
                       ...
                       <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li class="nav-item">
                            <div class="d-flex">
                                <button class="btn btn-outline-danger dropdown-item">Выйти</button>
                            </div>
                        </li>   
                    </ul>                     
                </li>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="">
                    ...
                    <div class="row mb-3">
                        <label for="inputPas" class="col-sm-2 col-form-label">Пароль</label>
                        <div class="col-sm-10">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn-secondary"  data-bs-dismiss="modal">Закрыть</button>
                </div>
            </div>
        </div>
     </div>

     <div class="modal fade" id="registerModal" tabindex="-1" aria-bs-labelledby="refisterModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="refisterModalLabel">Регистрация</h5>
                    <button class="btn-close" data-bs-dismiss="modal" aria-bs-label="Close" ></button>
                </div>
                <div class="modal-body">
                <form action="">
                    ...
                    <div class="row mb-3">
                        <label for="inputPas" class="col-sm-2 col-form-label">Повторите пароль</label>
                        <div class="col-sm-10">
                            <input type= "password" class="form-control" id="inputPas">
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button class="btn-secondary">Зарегистрироваться</button>
                    <button class="btn-secondary"  data-bs-dismiss="modal">Отмена</button>
                </div>
            </div>
        </div>
     </div>-->
